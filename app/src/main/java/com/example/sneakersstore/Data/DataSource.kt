...
object DataSource {
    val products = listOf(
        ...
        Product("2", R.drawable.nike_running_estrada, R.string.product_name3, R.string.product_desc1, 7.2),
        Product("3", R.drawable.sapatilhas_de_running_estrada, R.string.product_name4, R.string.product_desc1, 6.2),
        Product("4", R.drawable.nike_pagasus_33, R.string.product_name2, R.string.product_desc1, 7.2),)
